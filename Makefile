...
U_SRCS = init.c cp3_tests.c cp4_tests.c exec_test.c grow_ustack_toomuch.c cp5_tests.c memory_trap_handler_tests.c io_syscalls_tests.c ipc_syscalls_tests.c terminal_tests.c
U_INCS = 
