...
K_SRCS =  kernel.c trap_handlers.c kernel_data_structs.c queue.c load_program.c syscalls.c scheduler.c address_validation.c hash.c
K_INCS = 
...
U_SRCS = init.c cp3_tests.c cp4_tests.c exec_test.c grow_ustack_toomuch.c cp5_tests.c memory_trap_handler_tests.c io_syscalls_tests.c ipc_syscalls_tests.c sync_syscalls_tests.c torture.c
U_INCS = 
